...
public class ScreenTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.w_h).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ScreenTestActivity.this, root.getWidth()+"  "+root.getHeight(), Toast.LENGTH_SHORT).show();
            }
        });
    }
